    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          {pwaManager.isIOS ? (
            <div className="mt-2.5 flex items-center gap-1.5 text-[#1F77B4] text-xs font-semibold flex-wrap">
              <Share className="w-3.5 h-3.5 flex-shrink-0" />
              <span>Tap</span>
              <span className="px-1.5 py-0.5 bg-[#F7F9FC] rounded text-[10px] border border-[#E5E7EB]">Share</span>
              <span>→</span>
        ...
        <button
          onClick={dismiss}
          className="p-1.5 rounded-full flex-shrink-0 text-[#6B7280] hover:text-white active:bg-white/10 transition-all"
        >
          <X className="w-4 h-4" />
        </button>
      </div>
