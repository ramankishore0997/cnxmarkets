export function EcmLogo({ size = 36 }: { size?: number }) {
  ...
  return (
    <svg width={s} height={s} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="36" height="36" rx="8" fill="#0B0E11"/>
      <rect x="0.5" y="0.5" width="35" height="35" rx="7.5" stroke="#FFB800" strokeOpacity="0.55" strokeWidth="1"/>
      ...
      <rect x="13.5" y="11" width="5" height="13" rx="1.2" fill="#FFB800"/>
      <rect x="15.7" y="7" width="1.6" height="4.5" rx="0.8" fill="#FFB800"/>
      <rect x="15.7" y="24" width="1.6" height="3.5" rx="0.8" fill="#FFB800"/>
      ...
      <polyline points="3,31 16.5,17 24.5,13 33,5" stroke="#FFB800" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.35"/>
    </svg>
  );
}
